...
import com.erp.platform.modules.hr.service.LeaveTypeService;
...
public class LeaveTypeController {
    ...
    public ResponseEntity<ApiResponse<PageResponse<Map<String, Object>>>> list(
        ...
        return ResponseEntity.ok(ApiResponse.success(leaveTypeService.list(PageRequest.of(page, size))));
    }

    @GetMapping("/all")
    public ResponseEntity<ApiResponse<List<Map<String, Object>>>> listAll() {
        return ResponseEntity.ok(ApiResponse.success(leaveTypeService.listAll()));
    }
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> create(@RequestBody Map<String, Object> req) {
        return ResponseEntity.ok(ApiResponse.success(leaveTypeService.create(req)));
    }

    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<Map<String, Object>>> update(@PathVariable UUID id, @RequestBody Map<String, Object> req) {
        return ResponseEntity.ok(ApiResponse.success(leaveTypeService.update(id, req)));
    }
