...
public interface DeliveryNoteRepository extends JpaRepository<DeliveryNote, UUID> {
    Page<DeliveryNote> findByTenantIdAndDeletedAtIsNull(UUID tenantId, Pageable pageable);
    Optional<DeliveryNote> findByTenantIdAndIdAndDeletedAtIsNull(UUID tenantId, UUID id);
